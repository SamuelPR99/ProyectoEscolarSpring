...
footer {
	...
	z-index: 1000;
	/* Asegura que el footer esté encima de otros elementos */
	text-align: center;
}
...
translateY(
-5px
); /* Desplazamiento hacia arriba a la mitad de la animación */
}
100
%
{
...
background-color
:
#72b336; /* Naranja a la mitad de la animación */
}
100
%
{
...
.BotonUsuario input[type="text"]:hover, .BotonContraseña input[type="password"]:hover
	{
	transition: all;
	transition: 0.7s;
...
.BotonContraseña input[type="text"]:focus, .BotonUsuario input[type="password"]:focus
	{
	transition: all;
	transition: 0.5s;
...
.todo {
	...
	/* Color con opacidad (aquí se utiliza 0.5 para el 50% de opacidad) */
	float: left;
	margin-top: 230px;
	box-shadow: 0px 3px 10px 10px rgba(0, 0, 0, 0.2);
	height: 900px;
		...
		<div class="todo">
			...
			<form id="loginForm">
				...
				<div class="BotonContraseña">
					<label for="password"></label> <input placeholder="Contraseña..."
